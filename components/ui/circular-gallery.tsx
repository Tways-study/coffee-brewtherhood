...
class App {
  ...
  constructor(
    container: HTMLElement,
    { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px Figtree", scrollSpeed = 2, scrollEase = 0.05 }: AppConfig = {}
  ) {
  ...
  addEventListeners() {
    ...
    this.container?.addEventListener("keydown", this.boundOnKeyDown as EventListener);
  }
  destroy() {
    ...
    this.container?.removeEventListener("keydown", this.boundOnKeyDown as EventListener);
  }
}
